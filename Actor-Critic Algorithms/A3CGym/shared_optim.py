...
#setting the steps, exponential average and exponential average squared tozeroes effectively.
...
class SharedRMSprop(torch.optim.RMSprop):
    ...
    def __init__(self, params, lr=1e-2, alpha=0.99, eps=1e-8, weight_decay=0):
        ...
        # State initialisation (must be done before step, else will not be
